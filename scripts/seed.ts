...
const product1 = await productModel.create({
  ...
  price: 200,
  image: 'imageUrl',
  activity_day: "10/05/2025",
  activity_duration: 180,
  activity_department_id: department1._id,
...
const product11 = await productModel.create({
  name: 'Espeología en las cuevas de la sirenita',
...
const user1 = await userModel.create({
  ...
  dni: '38290481',
  email: 'gojo.catara@turismoplus.com',
  password: hashedPassword,
  telephone: '194736271',
  is_available: true,
});
...
const user2 = await userModel.create({
  names: 'Itadori Yuji',
  last_names: 'Morales García',
  dni: '48392017',
  email: 'yuji.morales@naturaleza360.net',
  password: hashedPassword,
  telephone: '987654321',
  is_available: true,
});
...
const user3 = await userModel.create({
  names: 'Nobara Kugisaki',
  last_names: 'Lopez Ríos',
  dni: '50483920',
  email: 'nobara.rios@aventuraperu.org',
  password: hashedPassword,
  telephone: '912345678',
  is_available: false,
});
...
const user4 = await userModel.create({
  names: 'Megumi Fushiguro',
  last_names: 'Torres Salas',
  dni: '41928375',
  email: 'megumi.salas@viajefeliz.pe',
  password: hashedPassword,
  telephone: '923456789',
  is_available: true,
});
...
const user5 = await userModel.create({
  names: 'Maki Zenin',
  last_names: 'Quispe Flores',
  dni: '39847265',
  email: 'maki.zenin@explorandes.com',
  password: hashedPassword,
  telephone: '934567891',
  is_available: false,
});
...
const user6 = await userModel.create({
  names: 'Toge Inumaki',
  last_names: 'Gonzales Vega',
  dni: '40238492',
  email: 'toge.gonzales@senderosmagicos.net',
  password: hashedPassword,
  telephone: '944567812',
  is_available: true,
});
...
const user7 = await userModel.create({
  names: 'Panda Kenta',
  last_names: 'Ramirez Duran',
  dni: '38712943',
  email: 'panda.duran@bosquedeaventura.pe',
  password: hashedPassword,
  telephone: '955678123',
  is_available: true,
});
...
const user8 = await userModel.create({
  names: 'Kento Nanami',
  last_names: 'Soto Medina',
  dni: '47630128',
  email: 'kento.soto@exploramontanas.org',
  password: hashedPassword,
  telephone: '966789234',
  is_available: false,
});
...
const user9 = await userModel.create({
  names: 'Yuta Okkotsu',
  last_names: 'Navarro Ruiz',
  dni: '49283746',
  email: 'yuta.ruiz@rutainka.com',
  password: hashedPassword,
  telephone: '977890345',
  is_available: true,
});
...
const user10 = await userModel.create({
  names: 'Shoko Ieiri',
  last_names: 'Campos Herrera',
  dni: '38592017',
  email: 'shoko.campos@viveselviaje.net',
  password: hashedPassword,
  telephone: '988901456',
  is_available: true,
});
